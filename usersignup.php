...
if($_SERVER["REQUEST_METHOD"]=="POST")
{
  ...
  //  }
  //}
    $query="INSERT INTO client_table(client_name, age, phone_no, gender,address , profession, occasion, username, password) VALUES('$name','$age','$phone','$gender','$address','$prof','$occasion','$username','$pass')";
